...
#plot
pdf("/media/dftortosa/Windows/Users/dftor/Documents/diego_docs/science/other_projects/helena_study/helena_7/results/figures/figures_fdr_0.1.pdf", height = 10, width = 7)
...
#plot
cairo_pdf("/media/dftortosa/Windows/Users/dftor/Documents/diego_docs/science/other_projects/helena_study/helena_7/results/figures/figures_interact_PA_factor.pdf", height = 10, width = 7, onefile=TRUE)#onefile=TRUE to get all pages in the same file
...
plot_pvals = function(pheno, output){
    ...
    #open a pdf
    pdf(paste("/media/dftortosa/Windows/Users/dftor/Documents/diego_docs/science/other_projects/helena_study/helena_7/results/figures/figures_suple_pvals/", output, ".pdf", sep=""), width=7, height=9)
...
path_suples = list.files("/media/dftortosa/Windows/Users/dftor/Documents/diego_docs/science/other_projects/helena_study/helena_7/results/figures/figures_suple_pvals", pattern="figure_S")
